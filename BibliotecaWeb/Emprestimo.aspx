<%@ Page Title="Meus Emprestimos" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Emprestimo.aspx.cs" Inherits="BibliotecaWeb.Emprestimo" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
	...
	<div>
		...
		<asp:GridView ID="locacaoGridView" runat="server" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" Width="530px" AllowSorting="True" BorderStyle="Solid" EmptyDataText="Nenhum resultado encontrado.">
			...
			<Columns>
				...
				<asp:BoundField DataField="DataEntrega" HeaderText="Data de Devolução" DataFormatString="{0:d}" />
	...
	<div>
			<asp:Button ID="Button" runat="server" Text="Renovar" OnClick="RenovarButton_Click" CssClass="btn btn-default" ClientIDMode="static" CssClassDisabled="false"/>
