<%@ Page Title="Alterar Senha" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ResetPassword.aspx.cs" Inherits="BibliotecaWeb.Account.ResetPassword" Async="true" %>
    ...
    <div class="form-horizontal">
        ...
        <div class="form-group">
            <div class="col-md-offset-2 col-md-10">
                <asp:Button runat="server" OnClick="Reset_Click" Text="Alterar" CssClass="btn btn-default" />
            </div>
        </div>
    </div>
</asp:Content>
